...
private fun String.toRecordingMethod(): RecordingMethod =
    RecordingMethod.entries.find { it.name == this } ?: RecordingMethod.UNKNOWN

private fun String.toHealthDeviceType(): HealthDeviceType =
    HealthDeviceType.entries.find { it.name == this } ?: HealthDeviceType.UNKNOWN
