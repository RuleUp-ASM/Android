 ...
 *
 * @property deviceId "같은 **기기**냐" — 단일 활성 기기 판정 키다. 서버는 저장된 값과 다르면 기존
 *   세션을 끊고 그 기기에 알린다. 앱을 지웠다 깔았다고 다른 기기가 된 건 아니므로 **재설치에는
 *   살아남고** 기기 교체·초기화에는 바뀌어야 한다.
 * @property installationId "같은 **설치본**이냐" — 한 설치에 계정 하나(`INSTALLATION_ALREADY_REGISTERED`)
 *   와 제재 회피 재가입 판별에 쓴다. 정의상 **재설치하면 새 값**이어야 한다.
 */
